...
def main():
    ...
    # 定义数据文件夹路径
    train_mri_dir = '/root/autodl-tmp/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/PET-MRI/train/MRI'
    train_pet_dir = '/root/autodl-tmp/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/PET-MRI/train/PET'
    # 如果需要，可以取消注释并修改以下路径
